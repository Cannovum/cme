...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"test_env.js":[function(require,module,exports) {
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          observer = new MutationObserver(function (mutationList, obersver) {
            mutationList.forEach(function (mutation) {
              if (mutation.type === "childList" && document.querySelector("#dc_login_iframe")) {
                document.querySelector("#dc_login_iframe").parentNode.replaceChildren(loginLink);
