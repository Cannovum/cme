	...
	async function checkPlayer() {
		if (!lesson["public"]) {
			MemberStack.onReady.then((member) => {
				...
				<iframe align="left" frameborder="0" scrolling="no" width="467" height="231" name="dc_login_iframe" id="dc_login_iframe" src="https://login.doccheck.com/code/de/2000000016834/login_xl/" style="border-radius: 16px"><a href="https://login.doccheck.com/code/de/2000000016834/login_xl/" target="_blank">LOGIN</a></iframe>`
